...
public class RedisUtil {
	 ...
	 * @return
	 */
	public LinkedHashSet<TypedTuple<Object>> zRangeWithScores(String key, long start, long end) {
		return new LinkedHashSet<TypedTuple<Object>>(redisTemplate.opsForZSet().rangeWithScores(key, start, end));
	}
	 ...
	 * @return
	 */
	public org.springframework.data.redis.core.Cursor<TypedTuple<Object>> zScan(String key, ScanOptions options) {
