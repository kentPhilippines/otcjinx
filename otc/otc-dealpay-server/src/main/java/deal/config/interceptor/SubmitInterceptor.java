...
public class SubmitInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		  ...
		  if (!(handler instanceof HandlerMethod)) 
	        ...
	        if(redisUtil.hasKey(RedisConstant.User.SUBMIT_URL+name+user.getUserId()+parameter)) 
	        	object = redisUtil.get(RedisConstant.User.SUBMIT_URL+name+user.getUserId()+parameter);
