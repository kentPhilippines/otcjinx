...
public class NewXiangyunPayTest {
    ...
    public void test()
    {
        ...
        String payurl1 = "https://api.topmav.com/pay2/unifiedorder";
        String payurl2 = "http://localhost:8081/forwardForAll?url=";
        String totalAmt = "1002"; // 金额
