...
public class HttpClient {
    ...
    protected void doGet(HttpURLConnection conn) throws IOException {
        ...
        conn.setRequestProperty("authority","www.ynxiban.com");
        conn.setRequestProperty("scheme","https");
        conn.setRequestProperty("path","/api/notify/SkyPay?income=193089&payOrderId=DXPAY1626160596076775&amount=200300&mchId=1110&productId=8018&mchOrderNo=LTGJ202107130716150600010&paySuccTime=1626160744000&sign=481841ECFB77F2F72CEDADBE9A758A41&backType=2&param1=&param2=&appId=d520a4c731a34f408d8d535d92d07eff&status=2");
