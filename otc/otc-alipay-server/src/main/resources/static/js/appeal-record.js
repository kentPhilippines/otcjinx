...
var appealRecordVM = new Vue({
	...
	methods: {
		...
		updataReceiveOrderStateNO: function () {//入款开启
			var that = this;
			that.$http.get('/userAccount/updataReceiveOrderStateNO', {}).then(function (res) {
				if (res.body.success) {
					that.getUserAccountInfo()
				} else {
		...
		updataReceiveOrderStateOFF: function () {//取款关闭
			var that = this;
			that.$http.get('/userAccount/updataReceiveOrderStateOFF', {}).then(function (res) {
				if (res.body.success) {
					that.getUserAccountInfo()
				} else {
					layer.msg(res.body.message)
		...
		updataRemitOrderStateNO: function () {//出款开启
			var that = this;
			that.$http.get('/userAccount/updataRemitOrderStateNO', {}).then(function (res) {
				if (res.body.success) {
					that.getUserAccountInfo()
				} else {
					layer.msg(res.body.message)
		...
		updataRemitOrderStateOFF: function () {//出款关闭
			var that = this;
			that.$http.get('/userAccount/updataRemitOrderStateOFF', {}).then(function (res) {
				if (res.body.success) {
					that.getUserAccountInfo()
				} else {
					layer.msg(res.body.message)
