...
@Component("HongguanPay")
public class HongguanPay extends PayOrderService {
    ...
    public Result deal(DealOrderApp dealOrderApp, String channel) throws Exception {
        log.info("【进入HongguanPay支付，当前请求产品：" + dealOrderApp.getRetain1() + "，当前请求渠道：" + channel + "】");
        ...
        Result result = createOrder(
                userInfo.getDealUrl() +
                        PayApiConstant.Notfiy.NOTFIY_API_WAI + "/hongguanNotify",
    ...
    private Result createOrder(String s, BigDecimal orderAmount, String orderId, ChannelInfo channelInfo, String payInfo, String orderAccount) {
        ...
        try {
            ...
            sign = PayUtil.md5(sign).toLowerCase();
            map.put("sign", sign);
            JSONObject jsonObject = JSONUtil.parseObj(map);
            log.info("hongguan请求参数：" + jsonObject.toString());
            String post = HttpUtil.post(channelInfo.getDealurl(), jsonObject.toString());
            log.info("hongguan响应参数：" + post.toString());
