...
public class PayConstant {
    ...
    public final static byte PAY_STATUS_ILLEGAL = 5;    // 订单非法
    ...
    public final static byte LOAN_STATUS_ING = 0;        // 审核中
    public final static byte LOAN_STATUS_SUCCESS = 1;    // 成功
    public final static byte LOAN_STATUS_FAIL = 2;        // 失败
    ...
    public final static String MCH_NOTIFY_TYPE_OBFLOW = "5";    // 商户通知类型:流水通知
    ...
    public static final byte YST_MSG_OK = 1;
    public static final byte YST_MSG_GUAZHANG = 2;
    public static final byte YST_MSG_GUAZHANG_COMPLETED = 3;
    ...
    public static boolean retIsSuccess(JSONObject retObj) {
        ...
        return retObj.getBoolean("isSuccess");
    }
}
