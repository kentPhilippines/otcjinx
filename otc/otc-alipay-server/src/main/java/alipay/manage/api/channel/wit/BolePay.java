...
@Component("BolePay")
public class BolePay extends PayOrderService {
    @Autowired
    ...
    public Result withdraw(Withdraw wit) {
        ...
        try {
            ...
            String createDpay = createDpay(userInfo.getDealUrl().toString() + PayApiConstant.Notfiy.NOTFIY_API_WAI + "/BolePay-notify", wit,channelInfo);
...
//        String notifyUrl = "http://34.92.251.112:9010/notfiy-api-pay/newXiangyunWit-notify";
        ...
        String bankCode = wit.getBankName();

        MultiValueMap<String, String> param= new LinkedMultiValueMap<String, String>();
        param.add("appId", user);
        param.add("appOrderNo", orderId);
