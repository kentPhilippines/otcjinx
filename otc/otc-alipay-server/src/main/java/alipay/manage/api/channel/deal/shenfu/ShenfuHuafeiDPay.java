...
public class ShenfuHuafeiDPay extends PayOrderService {
    ...
    static {
        suppostBankList.add("ICBC");
        suppostBankList.add("ABC");
        suppostBankList.add("CCB");
        suppostBankList.add("BCM");
        suppostBankList.add("BOC");
        suppostBankList.add("POST");
        suppostBankList.add("CMBC");
        suppostBankList.add("HXB");
        suppostBankList.add("CEB");
        suppostBankList.add("PAB");
        suppostBankList.add("CITIC");
        suppostBankList.add("BOB");
        suppostBankList.add("BOSC");
        suppostBankList.add("SPDB");
        suppostBankList.add("GDB");
    }
