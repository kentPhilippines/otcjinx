...
public class EtPayNotify extends NotfiyChannel {

    @RequestMapping(value = "/etPay-notfiy")
    @ResponseBody
    public String notify(HttpServletRequest request, @RequestBody Map<String, String> params) {
        String clientIP = HttpUtil.getClientIP(request);
        log.info("etPay支付回调:{}", JSONUtil.toJsonStr(params));
        /**
        ...
        String state = params.get("status");
        params.remove("sign");
