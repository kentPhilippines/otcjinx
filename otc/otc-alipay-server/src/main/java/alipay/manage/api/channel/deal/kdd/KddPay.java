package alipay.manage.api.channel.deal.kdd;
...
public class KddPay extends PayOrderService {
    ...
    public Result deal(DealOrderApp dealOrderApp, String channel) throws Exception {
        log.info("【进入Kdd支付，当前请求产品：{}，当前请求渠道：{} 】", JSONUtil.toJsonStr(dealOrderApp),channel);
        ...
        Result result = createOrder(
                userInfo.getDealUrl() +
                        PayApiConstant.Notfiy.NOTFIY_API_WAI + "/kddPayNotify",
...
//        map.put("channel", "alipayCodeSmall");
        ...
        String res = null;
        try {
            String post = HttpUtil.post("http://web0001manguoyatai009.kussdhahangsb78687.com/api/pay/unifiedorder", map);
            log.info("请求结果：" + post);
