...
public class LeliAliPay extends PayOrderService {
    @Autowired
    ...
    public Result deal(DealOrderApp dealOrderApp, String channel) throws Exception {
        log.info("【进入leliPay支付，当前请求产品：" + dealOrderApp.getRetain1() + "，当前请求渠道：" + channel + "】");
...
//        String user = "988001944000367";// 商户id
        ...
        {
            String url = jsonObject.getStr("codeImgUrl");
