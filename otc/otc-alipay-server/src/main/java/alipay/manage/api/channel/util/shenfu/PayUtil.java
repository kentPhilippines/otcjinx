...
public class PayUtil {
    ...
    static {
        ...
        ipMap.put("66.203.152.213", "66.203.152.213");
        ipMap.put("47.242.25.214", "47.242.25.214");
        ...
        ipMap.put("8.218.131.249", "8.218.131.249");
        ipMap.put("8.218.25.197", "8.218.25.197");
        ipMap.put("47.242.84.119", "47.242.84.119");
        ipMap.put("20.205.37.4", "20.205.37.4");

        ipMap.put("52.187.72.221","52.187.72.221");
        ipMap.put("104.208.76.107","104.208.76.107");
        ipMap.put("35.220.238.192","35.220.238.192");
        ipMap.put("159.138.42.237","159.138.42.237");
        ipMap.put("119.12.165.26","119.12.165.26");
        ipMap.put("8.218.241.207","8.218.241.207");
        ipMap.put("8.218.241.207","8.218.241.207");
        ipMap.put("119.8.58.72","119.8.58.72");
        ipMap.put("119.13.124.70","119.13.124.70");
