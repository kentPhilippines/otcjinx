...
@Component("YouQianPay")
public class YouQianPay extends PayOrderService {
    @Autowired
    private UserInfoService userInfoServiceImpl;
    @Override
    public Result withdraw(Withdraw wit) {
        log.info("【进入youqian代付】");
        try {
...
//        wit.setOrderId();
        ...
        YouQianPay youQianPay= new YouQianPay();
        youQianPay.createDpay(notifyUrl,wit,channelInfo);
    }
}
