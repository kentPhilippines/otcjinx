...
public class AmountPublic extends Util {
    ...
    public Result addQuotaAmount(UserFund userFund, BigDecimal balance) {
		return amountConfig.addAmountBalance(userFund, balance, ADD_QUOTA, new BigDecimal(0));
    }
    ...
    public Result deleteQuotaAmount(UserFund userFund, BigDecimal balance) {
		return amountConfig.deleteAmountBalance(userFund, balance, DELETE_QUOTA);
    }
    ...
    public Result addAmounRecharge(UserFund userFund, BigDecimal balance) {
		return amountConfig.addAmountBalance(userFund, balance, ADD_AMOUNT_RECHARGE, new BigDecimal(0));
	}
	...
	public Result addAmounProfit(UserFund userFund , BigDecimal balance) {
		return amountConfig.addAmountBalance(userFund, balance, ADD_AMOUNT_PROFIT, new BigDecimal(0));
	}
	/**
	...
	public Result addAmountAdd(UserFund userFund , BigDecimal balance) {
		return amountConfig.addAmountBalance(userFund, balance, ADD_AMOUNT, new BigDecimal(0));
	}
	...
	public Result addDeal(UserFund userFund, BigDecimal balance, BigDecimal dealAmount) {
		return amountConfig.addAmountBalance(userFund, balance, ADD_AMOUNT_DEAL, dealAmount);
	}
	...
	public Result addFreeze(UserFund userFund, BigDecimal freezeAmont) {
		return amountConfig.addAmountBalance(userFund, freezeAmont, ADD_FREEZE, new BigDecimal(0));
	}
	...
	public Result addDealApp(UserFund userFund, BigDecimal balance) {
		return amountConfig.addAmountBalance(userFund, balance, ADD_AMOUNT_DEAL_APP, new BigDecimal("0"));
	}
	/**
	...
	public Result deleteDeal(UserFund userFund , BigDecimal balance) {
		return amountConfig.deleteAmountBalance(userFund, balance, DELETE_DEAL);
	}
	/**
	...
	public Result deleteWithdraw(UserFund userFund , BigDecimal balance) {
		return amountConfig.deleteAmountBalance(userFund, balance, DELETE_WITHDRAW);
	}
	/**
	 * <p>人工扣款接口</p>
	 * @param userFund
	...
	public Result deleteAmount(UserFund userFund , BigDecimal balance) {
		return amountConfig.deleteAmountBalance(userFund, balance, DELETE_AMOUNT);
	}
	/**
	...
	public Result deleteFreeze(UserFund userFund , BigDecimal balance) {
		return amountConfig.deleteAmountBalance(userFund, balance, DELETE_FREEZE);
	}
}
